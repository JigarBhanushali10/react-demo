    ...
    return <div className=' border p-3 m-3'>
        ...
        <div className='d-flex justify-content-evenly '>
            <div className='border p-1 m-1'>
                ...
                <button className='btn btn-danger mx-3' onClick={() => props.decreamentCounterMethodAsProps('Decremented from Grand Child')}>Parent Decreament</button>
            </div>
            <div className='border p-1 m-1'>
                ...
                <button className='btn btn-danger mx-3' onClick={() => props.decreamentChildCounterMethodAsProps('Decremented from Grand Child')}>Child Decreament</button>
            </div>
            <div className='border p-1 m-1'>
                ...
                <button className='btn btn-danger mx-3' onClick={() => decreamentGrandChildCounter('Decremented from Grand Child')}>GrandChild Decreament</button>
            </div>
        </div>
        {props.children}
    </div>
