    ...
    return <div className=' border p-3 m-3'>
        ...
        <div className='d-flex justify-content-evenly '>
            <div className='border p-1 m-1'>
                ...
                <button className='btn btn-danger mx-3' onClick={()=>decreamentCounter('Decreament Form Parent')}>Parent Decreament</button>
            </div>
            <div className='border p-1 m-1'>
                ...
                <button className='btn btn-danger mx-3' onClick={()=>decreamentChildCounter('Decreament Form Parent')}>Child Decreament</button>
            </div>
            <div className='border p-1 m-1'>
                <small className='d-block p-2'>
                    Using useRef 
                ...
                <button className='btn btn-danger mx-3' onClick={()=>decreamentGrandChildCounter('Decreament Form Parent')}>GrandChild Decreament</button>
            </div>
        </div>
